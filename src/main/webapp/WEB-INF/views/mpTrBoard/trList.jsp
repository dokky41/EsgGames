		...
		<div class="container" >
			<div class="row">
				<div class="col-md-6">
					<h3 class="community-top-title">
						<a href="${PageContext.request.contextPath}/mpTrBoard/trList" class="text-subject">
				...
				<div class="col-md-6 text-lg-right">
						...
						onclick="location.href='${PageContext.request.contextPath}/mpTrBoard/trWrite'"
			...
			<table class="table" style="font-size: 20px;">
				...
				<tbody style="text-align: center;">
					<c:choose>
						<c:when test="${fn:length(trMpList) > 0 }">
							<c:forEach var="list" items="${trMpList}"  >
								
								<tr style="color: white;">
									<th scope="row">${list.num }</th>
									<td >
									<a href="${pageContext.request.contextPath }/mpTrBoard/trContent?num=${list.num}&page=<%=request.getParameter("page") %>"
				...
				<div style="float: left;">
						<button class="text-subject2"
							onclick="location.href='/mpTrBoard/trList?sort=def&page=1' ;return false;"
							style="cursor: pointer; "><b>최신순</b></button>

						<button class="text-subject2"
							onclick="location.href='/mpTrBoard/trList?sort=sel&page=1' ;return false;"
							style="cursor: pointer; "><b>조회순</b></button>
 
						<button class="text-subject2"
							onclick="location.href='/mpTrBoard/trList?sort=pri&page=1' ;return false;"
							style="cursor: pointer;  "><b>가격순↓</b></button>

						<button class="text-subject2"
							onclick="location.href='/mpTrBoard/trList?sort=pri2&page=1' ;return false;"
							style="cursor: pointer;  "><b>가격순↑</b></button>
				...
				action="${PageContext.request.contextPath}/mpTrBoard/trList?sort=def"
				method="post">
