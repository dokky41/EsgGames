...
<div class="latest-news-section">
	<a href="https://m-lostark.game.onstove.com/News/Notice/List"
		target='_blank'>
		<div class="ln-title"><b>LOL 뉴스</b></div>
	</a>
		...
		<div class="container" >
			<div class="row">
				<div class="col-md-6">
					<h3 class="community-top-title">
						<a href="${PageContext.request.contextPath}/lolTrBoard/trList" class="text-subject">
				...
				<div class="col-md-6 text-lg-right">
						...
						onclick="location.href='${PageContext.request.contextPath}/lolTrBoard/trWrite'"
			...
			<table class="table" style="font-size: 20px;">
				...
				<tbody style="text-align: center;">
					<c:choose>
						<c:when test="${fn:length(trLolList) > 0 }">
							<c:forEach var="list" items="${trLolList}"  >
								
								<tr style="color: white;">
									<th scope="row">${list.num }</th>
									<td >
									<a href="${pageContext.request.contextPath }/lolTrBoard/trContent?num=${list.num}&page=<%=request.getParameter("page") %>"
				...
				<div style="float: left;">
						<button class="text-subject2"
							onclick="location.href='/lolTrBoard/trList?sort=def&page=1' ;return false;"
							style="cursor: pointer; "><b>최신순</b></button>

						<button class="text-subject2"
							onclick="location.href='/lolTrBoard/trList?sort=sel&page=1' ;return false;"
							style="cursor: pointer; "><b>조회순</b></button>
 
						<button class="text-subject2"
							onclick="location.href='/lolTrBoard/trList?sort=pri&page=1' ;return false;"
							style="cursor: pointer;  "><b>가격순↓</b></button>

						<button class="text-subject2"
							onclick="location.href='/lolTrBoard/trList?sort=pri2&page=1' ;return false;"
							style="cursor: pointer;  "><b>가격순↑</b></button>
				...
				action="${PageContext.request.contextPath}/lolTrBoard/trList?sort=def"
				method="post">
