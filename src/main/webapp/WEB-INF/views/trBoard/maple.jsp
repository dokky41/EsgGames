...
<!-- 헤더부분 -->
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="${pageContext.request.contextPath }/resources/img/trMaple/slidermaple.jpg">
					...
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								<h5 style="color: blue;">박행균<span>posted an update</span></h5>
