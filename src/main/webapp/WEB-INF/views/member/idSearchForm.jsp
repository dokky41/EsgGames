...
<br>
<br>
<h5 class="login__fb-title" ><b>아이디 찾기</b></h5>
<br>

<form action="${pageContext.request.contextPath}/member/idSearchForm" id= "join" method="post">
<fieldset>

<div id="loginWrap" class="loginWrap">
				<div class="loginUserInfo">
					<p class="idWrap">
						<a style="color: black;"><b>이름</b></a><br>
						<input type="text" maxlength="50" 
						id="username" name="username" class="inputidpw" placeholder="이름" style="width: 288px;">
