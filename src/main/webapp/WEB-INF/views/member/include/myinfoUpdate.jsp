...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">내 정보 변경</h1>
</div>
<br>
...
<table width="100%" cellspacing="0" role="grid"
	aria-describedby="dataTable_info" style="width: 100%;" border="1"
	bordercolor="#e3e6f0">
	<thead>
		<tr role="row">
	...
	<tbody>
		<tr class="even" style="text-align: center;">
			...
			<td><input type="password" name="userpw" min="4" maxlength="12" placeholder="4~12자">
