			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="contact-form-warp">
						<h4 class="comment-title">수정  </h4>
						<form class="comment-form" action="${pageContext.request.contextPath}/battlegrounds/BGmodify" method="post" >
						<input type="hidden" value="${BGboard.num }" name="num"> 
<!-- 						num값 넘겨주는 코 -->
							<div class="row">
								<div class="col-md-6">
									<input type="text" placeholder="아이디를 입력하세요. " name="userid" value="${BGboard.userid }" readOnly>
								</div>
								<div class="col-md-6">
									<input type="text" placeholder="비밀번호 입력하세요. " name="boardpw" value="${BGboard.boardpw }" readOnly>
								</div>
								<div class="col-lg-12">
									<input type="text" placeholder="제목을 입력하세요.  " name="subject" value="${BGboard.subject }">
									<textarea placeholder="내용을 입력하세요.  " name="content">${BGboard.content }</textarea>
