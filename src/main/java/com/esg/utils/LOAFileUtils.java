...
public class LOAFileUtils {
	...
	public List<Map<String, Object>> parseFileInfo(LOABoardVO vo, MultipartFile[] file) throws Exception {
        ...
        for(int i=0; i<file.length; i++) {
            ...
            log.info("================== file start ==================");
            log.info("���� ���� �̸�: "+orgFileName);
            log.info("���� ���� �̸�: "+saveFileName);
            log.info("���� ũ��: "+saveFileSize);
