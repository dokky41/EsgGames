...
@Component("ydfileUtils")
public class ydFileUtils {
	private static final Logger log = LoggerFactory.getLogger(FileUtils.class);
	
	private static final String uploadPath = "C:\\test\\file\\";
	public List<Map<String, Object>> parseFileInfo(trLoaVO vo, MultipartFile[] file) throws Exception {
        
        String boardIDX = String.valueOf(vo.getNum());
        String creaID = (String) vo.getContent();
