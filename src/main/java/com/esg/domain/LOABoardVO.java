...
public class LOABoardVO {
	...
	public String toString() {
		return "LOABoardVO [IDX=" + IDX + ", TITLE=" + TITLE + ", CONTENTS=" + CONTENTS + ", HIT_CNT=" + HIT_CNT
				+ ", RECOMMEND=" + RECOMMEND + ", DEL_CHK=" + DEL_CHK + ", CREA_DATE=" + CREA_DATE + ", CREA_ID="
