...
public class mapleFileVO {
	...
	public String toString() {
		return "mapleFileVO [IDX=" + IDX +", BOARD_IDX=" + BOARD_IDX +",ORG_FILE_NAME=" + ORG_FILE_NAME +",SAVE_FILE_NAME="
				+ SAVE_FILE_NAME +",FILE_SIZE="+ FILE_SIZE +",UPDATE_DATE=" + UPDATE_DATE +",CREA_ID=" + CREA_ID +",DEL_CHK="
				+ DEL_CHK +",CREA_DATE=" + CREA_DATE + "]";
	}
